...
//MXL_pulley_dia = tooth_spacing (2.032,0.254, number_of_teeth);
//40DP_pulley_dia = tooth_spacing (2.07264,0.1778, number_of_teeth);
//XL_pulley_dia = tooth_spacing (5.08,0.254, number_of_teeth);
//H_pulley_dia = tooth_spacing (9.525,0.381, number_of_teeth);
//T2_5_pulley_dia = tooth_spaceing_curvefit (0.7467,0.796,1.026, number_of_teeth);
//T5_pulley_dia = tooth_spaceing_curvefit (0.6523,1.591,1.064, number_of_teeth);
//T10_pulley_dia = tooth_spacing (10,0.93, number_of_teeth);
//AT5_pulley_dia = tooth_spaceing_curvefit (0.6523,1.591,1.064, number_of_teeth);
//HTD_3mm_pulley_dia = tooth_spacing (3,0.381, number_of_teeth);
//HTD_5mm_pulley_dia = tooth_spacing (5,0.5715, number_of_teeth);
//HTD_8mm_pulley_dia = tooth_spacing (8,0.6858, number_of_teeth);
//GT2_2mm_pulley_dia = tooth_spacing (2,0.254, number_of_teeth);

//GT2_3mm_pulley_dia = tooth_spacing (3,0.381, number_of_teeth);
//GT2_5mm_pulley_dia = tooth_spacing (5,0.5715, number_of_teeth);
...
// Functions
// ---------
function tooth_spaceing_curvefit (b,c,d, number_of_teeth)
  = ((c * pow(number_of_teeth,d)) / (b + pow(number_of_teeth,d))) * number_of_teeth ;

function tooth_spacing(tooth_pitch,pitch_line_offset, number_of_teeth)
        ...
        difference(){
          ...
          for(i=[1:number_of_teeth]){
            rotate([0,0,i*(360/number_of_teeth)]){
              translate([0,-tooth_distance_from_centre,base_height]){
...
module GT2_2mm(depth)
  {
  linear_extrude(depth) polygon([[0.747183,-0.5],[0.747183,0],[0.647876,0.037218],[0.598311,0.130528],[0.578556,0.238423],[0.547158,0.343077],[0.504649,0.443762],[0.451556,0.53975],[0.358229,0.636924],[0.2484,0.707276],[0.127259,0.750044],[0,0.76447],[-0.127259,0.750044],[-0.2484,0.707276],[-0.358229,0.636924],[-0.451556,0.53975],[-0.504797,0.443762],[-0.547291,0.343077],[-0.578605,0.238423],[-0.598311,0.130528],[-0.648009,0.037218],[-0.747183,0],[-0.747183,-0.5]]);
  }
